...
export default function ButterToastProposalPage() {
  ...
  const sectionCover = (
    <div className="bg-[#FFFDF9] border border-[#E6DDCF] rounded-2xl md:rounded-3xl p-4 md:p-8 shadow-sm text-center">
      <div className="flex items-center justify-center gap-2 mb-2">
        <span className="h-[1px] w-6 bg-[#D6A86E]"></span>
        <span className="text-[10px] md:text-xs font-bold text-[#B26A27] tracking-wider uppercase font-mono">
          SPECIAL PROPOSAL ✕ 2026 品牌升級企劃
        </span>
        <span className="h-[1px] w-6 bg-[#D6A86E]"></span>
      </div>

      <h1 className="text-xl md:text-4xl font-black font-serif mb-2 leading-tight text-[#382D24]">
        【生乳/奶霜專賣店】<br />
        <span className="text-[#B26A27]">AI 品牌店長 24H 自動化專案</span>
      </h1>

      <p className="text-xs md:text-base text-[#7C6E62] max-w-2xl mx-auto mb-4 leading-relaxed font-medium">
        專為無專職小編門市打造的 <b>24 小時線上 AI 智慧總管 ✕ 老闆後台 AI 數據助手</b>！前台自動接單、後台實時推播<b>「完售/缺料警報」</b>與調閱今日業績、完成單數與未下單分析！
      </p>

      {/* 4 Feature Highlights Grid */}
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-2 mb-4 text-left">
        <div className="bg-white/90 border border-[#D6A86E] p-2.5 rounded-xl">
          <div className="text-xs font-bold text-[#B26A27] mb-1">🧸 吉祥物擬真人設</div>
          <p className="text-[11px] text-[#7C6E62] leading-tight">融入品牌娃娃溫暖語氣與口頭禪，建立親切感</p>
        </div>

        <div className="bg-white/90 border border-[#D6A86E] p-2.5 rounded-xl">
          <div className="text-xs font-bold text-[#B26A27] mb-1">🚨 完售與缺料警報</div>
          <p className="text-[11px] text-[#7C6E62] leading-tight">品項賣完或原物料低於警戒值，AI 秒級主動推播通知老闆</p>
        </div>

        <div className="bg-white/90 border border-[#D6A86E] p-2.5 rounded-xl">
          <div className="text-xs font-bold text-[#B26A27] mb-1">📊 後台 AI 數據 Copilot</div>
          <p className="text-[11px] text-[#7C6E62] leading-tight">店長直接查詢「今天業績/完成幾單/幾人沒下單」，AI 自動生成報表</p>
        </div>

        <div className="bg-white/90 border border-[#D6A86E] p-2.5 rounded-xl">
          <div className="text-xs font-bold text-[#B26A27] mb-1">🔔 雙向自動化提醒</div>
          <p className="text-[11px] text-[#7C6E62] leading-tight">預約完成憑證卡片 ✕ 廚房備貨完成取餐通知</p>
        </div>
      </div>

      <div className="inline-flex items-center flex-wrap justify-center gap-1.5 px-3 py-1.5 bg-[#B26A27] text-[#FFFDF9] rounded-full text-[11px] font-bold shadow-xs">
        <span>✨ 0 專職小編需求</span>
        <span>•</span>
        <span>✨ 完售缺料實時警報</span>
        <span>•</span>
      ...
      <div className="mt-3 pt-3 border-t border-[#E6DDCF] text-[11px] text-[#7C6E62] font-medium flex justify-center flex-wrap gap-2 md:gap-4">
  ...
  const sectionPainPoints = (
    <div className="bg-[#FFFDF9] border border-[#E6DDCF] rounded-2xl md:rounded-3xl p-4 md:p-8 shadow-sm space-y-3">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        <div className="bg-white border border-[#E6DDCF] rounded-xl p-3.5 shadow-xs">
          <div className="text-xl mb-1">🧸</div>
          <h3 className="font-serif font-bold text-sm text-[#B26A27] mb-1">需求 1：品牌娃娃人設口吻與商店介紹</h3>
        ...
        <div className="bg-white border border-[#E6DDCF] rounded-xl p-3.5 shadow-xs">
          <div className="text-xl mb-1">🧮</div>
          <h3 className="font-serif font-bold text-sm text-[#B26A27] mb-1">需求 2：奶霜炸吐司多品項自動算錢</h3>
          <p className="text-xs text-[#7C6E62] leading-relaxed">
        ...
        <div className="bg-white border border-[#E6DDCF] rounded-xl p-3.5 shadow-xs">
          <div className="text-xl mb-1">🤖</div>
          <h3 className="font-serif font-bold text-sm text-[#B26A27] mb-1">需求 3：AI 自動發送「預約完成✔️」與雙向通知</h3>
          <p className="text-xs text-[#7C6E62] leading-relaxed">
            目前無專職小編。當顧客確認訂購後，AI 自動發送「預約完成✔️」憑證卡片與廚房提示；廚房做完點擊「完成備貨」，AI 自動推播「餐點已備妥，請至指定地點取餐」給顧客！
          </p>
        </div>

        <div className="bg-white border-2 border-[#D6A86E] rounded-xl p-3.5 shadow-xs bg-amber-50/30">
          <div className="text-xl mb-1">🚨</div>
          <h3 className="font-serif font-bold text-sm text-[#B26A27] mb-1">需求 4：後台 AI 助手 ✕ 完售缺料實時警報</h3>
  ...
  const sectionPricing = (
    <div className="bg-[#FFFDF9] border border-[#E6DDCF] rounded-2xl md:rounded-3xl p-4 md:p-8 shadow-sm space-y-3">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        {/* Card 1: Setup Fee */}
        <div className="bg-white border-2 border-[#D6A86E] rounded-2xl p-4 shadow-xs flex flex-col justify-between">
          <div>
            ...
            <div className="text-xl md:text-2xl font-black font-mono text-[#B26A27] my-1">
        ...
        <div className="bg-white border-2 border-[#B26A27] rounded-2xl p-4 shadow-md flex flex-col justify-between">
          <div>
            <div className="flex justify-between items-center mb-1">
              <span className="font-bold text-xs md:text-sm text-[#B26A27]">
                💳 【每月】代營運與 AI 系統費
            ...
            <div className="text-[11px] bg-amber-50 border border-[#D6A86E] p-1.5 rounded-lg mb-2 text-[#382D24]">
          ...
          <button
            ...
            className="w-full py-2.5 px-3 bg-gradient-to-r from-[#B26A27] via-[#D6A86E] to-[#B26A27] hover:from-[#8F521B] hover:to-[#8F521B] text-white font-extrabold rounded-xl shadow-md transition flex items-center justify-center gap-1 text-xs cursor-pointer active:scale-95"
          >
            <span>💳</span>
      ...
      <div className="bg-gradient-to-br from-[#FFFDF9] to-[#FCEFDC] border-2 border-[#B26A27] rounded-2xl p-3 shadow-xs">
        <div className="flex justify-between items-center mb-1.5">
          ...
          <button
            ...
            className="px-2.5 py-1 bg-[#B26A27] text-white text-xs font-bold rounded-lg hover:bg-[#8F521B] transition"
          >
            {copySuccess ? "✓ 已複製" : "📋 複製帳號"}
          </button>
        </div>

        <div className="grid grid-cols-2 md:grid-cols-4 gap-2 text-xs bg-white/90 p-2 rounded-xl border border-[#D6A86E]">
          <div>
      ...
      {/* Invoice Info Form */}
      <div className="bg-white border border-[#E6DDCF] rounded-2xl p-3 shadow-xs">
        ...
        {isAdminView ? (
          <div className="bg-[#F7F3ED] p-2.5 rounded-xl border border-[#E6DDCF] max-h-40 overflow-y-auto space-y-1.5 text-xs">
            ...
            {invoiceRecords.length === 0 ? (
              ...
              invoiceRecords.map((r) => (
                <div key={r.id} className="bg-white p-2 rounded-lg border border-[#E6DDCF] space-y-0.5">
          ...
          <form onSubmit={handleSaveInvoiceInfo} className="grid grid-cols-1 md:grid-cols-2 gap-2 text-xs">
            ...
            <div className="md:col-span-2 text-right pt-1">
              <button
                ...
                className="px-3.5 py-1.5 bg-[#B26A27] hover:bg-[#8F521B] text-white font-bold rounded-lg text-xs transition"
              >
  ...
  const sectionTimeline = (
    <div className="bg-[#FFFDF9] border border-[#E6DDCF] rounded-2xl md:rounded-3xl p-4 md:p-8 shadow-sm space-y-3">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
        <div className="bg-white border border-[#E6DDCF] rounded-xl p-4 shadow-xs">
          <span className="inline-block px-2.5 py-0.5 bg-[#B26A27] text-white rounded-full text-[10px] font-bold mb-2">PHASE 1 (Week 1)</span>
          <h4 className="font-serif font-bold text-[#B26A27] mb-1.5 text-sm">遠端權限交接與雲端打單預設</h4>
        ...
        <div className="bg-white border border-[#E6DDCF] rounded-xl p-4 shadow-xs">
          ...
          <h4 className="font-serif font-bold text-[#B26A27] mb-1.5 text-sm">測試環境與線上視訊演練</h4>
          <ul className="text-xs text-[#7C6E62] space-y-1">
        ...
        <div className="bg-white border-2 border-[#B26A27] rounded-xl p-4 shadow-xs bg-amber-50/30">
          ...
          <h4 className="font-serif font-bold text-[#B26A27] mb-1.5 text-sm">無縫切換 ➔ 驗收開通 ➔ 保固</h4>
  ...
  const sectionChecklist = (
    <div className="bg-[#FFFDF9] border border-[#E6DDCF] rounded-2xl md:rounded-3xl p-4 md:p-8 shadow-sm space-y-3">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
        ...
        <div className="bg-emerald-50/70 border-2 border-emerald-500 rounded-xl p-3.5 shadow-xs">
          <h4 className="font-bold text-emerald-800 text-xs mb-1.5">🔒 企業級 AI 資安防護 4 大防線</h4>
  ...
  const sectionSummary = (
    <div className="bg-[#FFFDF9] border border-[#E6DDCF] rounded-2xl md:rounded-3xl p-4 md:p-8 shadow-sm space-y-3">
      ...
      <div className="bg-white border-2 border-[#B26A27] rounded-xl overflow-hidden shadow-xs">
        <table className="w-full text-left text-xs">
          <thead className="bg-[#EFE7DA] text-[#B26A27] font-bold border-b border-[#D6A86E]">
            <tr>
              <th className="p-2">評估比較項目</th>
              <th className="p-2 text-gray-500">真人小編</th>
              <th className="p-2 text-[#B26A27] bg-[#FFF8F0] font-black">🤖 AI 店長全代營運</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-[#E6DDCF] text-[#382D24]">
            <tr>
              <td className="p-2 font-bold">經營數據與日報</td>
              <td className="p-2 text-gray-600">晚上需人工打字算帳</td>
              <td className="p-2 font-bold text-emerald-700 bg-[#FFF8F0]"><b>後台 AI 經營助手自動計算業績與流失分析</b></td>
            </tr>
            <tr>
              <td className="p-2 font-bold">完售與缺料監控</td>
              <td className="p-2 text-gray-600">忘記手動改菜單易引糾紛</td>
              <td className="p-2 font-bold text-emerald-700 bg-[#FFF8F0]"><b>完售/缺料秒級主動推播警報給老闆</b></td>
            </tr>
            <tr>
              <td className="p-2 font-bold">單日對話處理容量</td>
              <td className="p-2 text-red-600 font-bold">每天最多 30~50 筆</td>
              <td className="p-2 font-black text-emerald-700 bg-[#FFF8F0]">單日精確處理 1,000+ 筆訂單</td>
            </tr>
            <tr>
              <td className="p-2 font-bold">每月固定費用成本</td>
              <td className="p-2 text-red-600 font-mono font-bold">NT$ 30,000 ~ 35,000</td>
      ...
      <div className="bg-gradient-to-r from-[#FFFDF9] via-[#FCEFDC] to-[#FFFDF9] border-2 border-[#B26A27] rounded-xl p-3 shadow-xs flex flex-col md:flex-row justify-between items-center gap-2">
        <div>
        ...
        <div className="flex items-center gap-2 md:gap-3 text-xs">
          <div className="bg-white/80 px-2.5 py-1 rounded-lg border border-[#D6A86E]">
  ...
  return (
    <div className="min-h-screen bg-[#F7F3ED] text-[#382D24] font-sans select-none overflow-x-hidden">
      ...
      {/* Top Header Bar */}
      <header className="sticky top-0 z-50 bg-[#F7F3ED]/90 backdrop-blur-md border-b border-[#E6DDCF] px-3 py-2">
      ...
      {/* Desktop Mode: Carousel / Slide Deck Mode (電腦大螢幕卡片切換模式) */}
      <div className="hidden md:flex min-h-[calc(100vh-60px)] flex-col justify-between items-center p-6 max-w-5xl mx-auto">
        <main className="w-full flex-1 my-2">
        ...
        <footer className="w-full flex justify-between items-center pt-3 border-t border-[#E6DDCF]">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="px-5 py-2 bg-white border border-[#E6DDCF] rounded-full text-sm font-bold text-[#382D24] hover:bg-[#B26A27] hover:text-white disabled:opacity-30 transition shadow-xs"
            >
              ← 上一頁
            </button>
            <button
            ...
            <button
              ...
              className="px-5 py-2 bg-[#EFE7DA] border border-[#D6A86E] text-[#B26A27] rounded-full text-sm font-bold hover:bg-[#B26A27] hover:text-white transition shadow-xs"
            >
              🖨️ 列印 / PDF
            </button>
          </div>
