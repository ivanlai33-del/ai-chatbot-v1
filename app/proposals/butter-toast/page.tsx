...
export default function ButterToastProposalPage() {
  ...
  useEffect(() => {
    sendProposalAuditTrack("butter-toast", "PAGE_VISITED_SESSION").then((res) => {
  ...
  // 🔴 3-Stage Lifecycle: Stage 3 (ARCHIVED_404 > 10 Days) & Manual Closure — 除非為管理者上帝視角
  ...
  return (
    <ProposalEditableProvider slug="butter-toast" isAdminBypass={isAdminBypass}>
          ...
          <div className="max-w-5xl mx-auto flex justify-between items-center">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-xs md:text-sm text-[#382D24]">
                <EditableText id="bt_header_title" defaultText="AI 品牌店長 24H 自動化專案 (奶油吐司旗艦版)" />
              </span>
            </div>
