            ...
            <div className="flex h-full gap-12">
                <div className="flex-1">
                    <header className="mb-12">
                        ...
                        >
                            開通企業專屬 AI 店長<br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#06C755] to-[#05A044]">
                                規模化導入方案
                            </span>
                        </motion.h1>
                        <motion.p
                ...
                <div className="hidden lg:block w-[400px] xl:w-[480px] shrink-0">
                    <div className="bg-white/60 backdrop-blur-3xl border border-white rounded-[3rem] overflow-hidden h-fit shadow-2xl">
                        <SaaSChatInterface
