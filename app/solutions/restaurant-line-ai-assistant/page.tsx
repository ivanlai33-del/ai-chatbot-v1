...
export const metadata: Metadata = {
    title: "餐飲業 LINE AI 客服與自動接單｜自動回覆菜單、訂位與營業資訊 | AI 智能店長 Pro",
    description: "專為台灣餐廳、飲料店、咖啡廳與居酒屋打造的 LINE AI 智慧客服工具。3分鐘串接，24H 自動回覆最新菜單、營業時間、訂位規範與外帶外送優惠，解決尖峰時段漏單痛點！",
    keywords: [
        '台灣餐廳 LINE AI 客服', '餐飲自動接單機器人', '餐廳 AI 智慧客服', 
        'LINE 官方帳號自動回覆菜單', '台北餐飲 POS AI 串接', '飲料店 LINE 點餐機器人',
        '餐飲業數位轉型工具', '24H 餐廳訂位 AI 助手', 'LINE 官方帳號經營'
    ],
    openGraph: {
        title: "餐飲業 LINE AI 客服與自動接單助手｜AI 智能店長 Pro",
        description: "專為台灣餐廳、飲料店、咖啡廳與居酒屋打造的 LINE AI 智慧客服工具。3分鐘串接，24H 自動回覆最新菜單與訂位規範，解決尖峰時段漏單痛點！",
    ...
    return (
        <IndustrySolutionLayout 
            ...
            faqs={[
                ...
                { q: '適合單店還是連鎖店？', a: '皆適合。我們目前主力推廣超值的「199 入門嚐鮮方案」，每天不到 $7 元即可讓單店或多店輕鬆體驗 24H AI 客服，完全無門檻與負擔。' }
            ]}
        />
    );
}
