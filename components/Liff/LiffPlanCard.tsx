  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between items-start mb-4">
        ...
        {popular && (
          <span className={`px-3 py-1 text-white text-[10px] font-black uppercase tracking-widest rounded-full flex items-center gap-1 shadow-md bg-gradient-to-r ${
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-slate-600 font-bold leading-relaxed">{description}</p>
      </div>

      <div className="flex items-baseline gap-2 mb-6">
        <span className={`text-4xl font-black tracking-tight bg-clip-text text-transparent bg-gradient-to-r ${
        ...
        <span className="text-sm text-slate-500 font-bold uppercase">{period}</span>
        {originalPrice && (
          <span className="text-sm text-slate-400 line-through ml-1 decoration-red-500/50">
            ${originalPrice}
          </span>
        )}
      </div>
      ...
      <button className={`w-full py-4 text-white rounded-2xl font-black text-sm shadow-xl active:scale-[0.98] transition-all flex items-center justify-center gap-2 bg-gradient-to-r ${
        color === 'emerald' ? 'from-emerald-500 to-green-600' : 
        color === 'amber' ? 'from-orange-500 to-amber-600' : 
        'from-blue-500 to-indigo-600'
      }`}>
