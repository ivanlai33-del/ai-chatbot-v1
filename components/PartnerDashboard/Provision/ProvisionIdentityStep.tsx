    ...
    return (
        ...
        >
            ...
            <button 
                onClick={onNext}
                disabled={!name}
                className="w-full bg-gradient-to-br from-[#06C755] to-[#05A044] text-white py-5 rounded-2xl font-black text-sm hover:shadow-xl hover:shadow-[#06C755]/20 transition-all flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed"
            >
                下一步：大腦設定
