                                ...
                                <>
                                    ...
                                    >
                                        <div className="p-6 text-center bg-slate-50/50">
                                            ...
                                            <p className="text-[10px] font-black uppercase text-slate-400 tracking-widest mt-1 mb-4">{plan.label} MEMBER</p>
                                        ...
                                        <div className="p-3 bg-slate-100/50 flex flex-col gap-1">
                                            <button 
                                                onClick={onLogout}
                                                className="w-full py-2.5 rounded-xl text-slate-500 hover:text-red-500 hover:bg-red-50 transition-all flex items-center justify-center gap-2 text-xs font-bold"
                                            >
